...
export default function PageContent(): ReactElement {
  return (
    <div>
      Base styles to style text in your application. **Note:** To use these classes you need
      `neptune.css` or `neptune-core.css` on your page. Refer to{' '}
      <DocumentLink href="/about/Setup#installation">Installation</DocumentLink> on the Setup page
      to get started.
      <Heading as="h2">Headings</Heading>
      Use <code>.title-1</code> , <code>.title-2</code> ... font styling classes for the headings.
      <b>
        Avoid using heading elements (<code>h1</code>–<code>h6</code>) without any class. Heading
        properties are the same for mobile and desktop.{' '}
      </b>{' '}
      ...
      ## Display headings Use display headings <code>.display-1</code>–<code>.display-5</code> to
      stand out from traditional section headers.
      <table className="table">
        <tbody>
          <tr>
            <td>
...
<span class="small">
  ...
  We’re on a mission to bring transparency to finance, for people without borders.
      ...
      #### Center `.text-xs|sm|md|lg|xl-center`
      <p className="text-xs-center">
        We’re on a mission to bring transparency to finance, for people without borders. We charge
        as little as possible, and we always show you upfront. No hidden fees. No bad exchange
        rates. No surprises.
      </p>
      #### Right `.text-xs|sm|md|lg|xl-right`
      <p className="text-xs-right">
        We’re on a mission to bring transparency to finance, for people without borders. We charge
        as little as possible, and we always show you upfront. No hidden fees. No bad exchange
        rates. No surprises.
      </p>
      #### Justify `.text-xs|sm|md|lg|xl-justify`
      <p className="text-xs-justify">
        We’re on a mission to bring transparency to finance, for people without borders. We charge
        as little as possible, and we always show you upfront. No hidden fees. No bad exchange
        rates. No surprises.
      </p>
      #### Nowap `.text-xs|sm|md|lg|xl-nowrap`
      <p className="text-xs-nowrap">
        We’re on a mission to bring transparency to finance, for people without borders.
      </p>
      ### Transformation classes #### Lowercase `.text-lowercase`
      ...
      ## Lists Unstyled list can be achieved using `.list-unstyled` class. ### Unordered list
      <ul>
